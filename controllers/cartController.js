...
// Handler function to get the cart data
...
// Handler function to delete a product from the cart
...
exports.updateProductCount = async (req, res) => {
  ...
  try {
    // Find the cart by the cart owner ID
    const cart = await Cart.findOne({ cartOwner: req.user.id });
